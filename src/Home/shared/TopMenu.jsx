                ...
                <div className="col-md-6">
                    <div>
                        ...
                        <div className='lh-base ms-2 mt-3 text-start'>
                            ...
                            <p className='lh-base mb-0 text-secondary'>নিজস্ব প্রতিবেদক: বিএনপি মহাসচিব মির্জা ফখরুল ইসলাম আলমগীর বলেছেন, দেশে কোনো মৌলবাদী দল কখনো ক্ষমতায় আসেনি, ভবিষ্যতেও আসতে পারবে না। জনগণের অধিকার রক্ষায় দেশের মানুষ জেগে উঠেছে, কোনো শক্তিই এই গণজোয়ার ঠেকাতে পারবে না।শনিবার (১৯ আগস্ট) সকালে শেরেবাংলা নগরে বিএনপির প্রতিষ্ঠাতা জিয়াউর রহমানের সমাধিতে পুষ্পস্তবক অর্পণ শেষে সাংবাদিক এসব কথা...</p>
                        </div>
                    </div>
